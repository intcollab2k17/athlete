...
$query1=mysqli_query($con,"select * from event where event_id='$eid'")or die(mysqli_error($con));
...
<?php
    ...
    $query1=mysqli_query($con,"select * from sports")or die(mysqli_error($con));
        while($row1=mysqli_fetch_array($query1)){
          $sport=$row1['sports_id'];

           $query2=mysqli_query($con,"select * from coach natural join member where sports_id='$sport' and event_id='$eid' and campus_id='$cid'")or die(mysqli_error($con));
...
<?php
    ...
    $query2=mysqli_query($con,"select * from athlete natural join member natural join event where event_id='$eid' and sports_id='$sport' and campus_id='$cid'")or die(mysqli_error($con));
